...
const ProductCard = ({ product, onAdd, image }: ProductCardProps) => (
  <div className="group relative flex flex-col gap-3">
    ...
    <button
      ...
      className="absolute bottom-[4.5rem] right-3 flex h-12 w-12 items-center justify-center rounded-full bg-primary text-primary-foreground shadow-lg transition-transform duration-150 active:scale-90"
